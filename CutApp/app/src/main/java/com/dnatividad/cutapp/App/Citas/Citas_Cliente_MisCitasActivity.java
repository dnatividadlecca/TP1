...
public class Citas_Cliente_MisCitasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_citas_cliente_mis_citas);
        setUrlOrigin();
        cargarCitas();
    }
    ...
    void updateLista(String reportList) {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    adaptadorCitas = new AdaptadorCitas(Citas_Cliente_MisCitasActivity.this, ListItems);
            ...
            listItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    Intent i = new Intent(getApplicationContext(), Citas_Cliente_DetalleCitaActivity.class);
