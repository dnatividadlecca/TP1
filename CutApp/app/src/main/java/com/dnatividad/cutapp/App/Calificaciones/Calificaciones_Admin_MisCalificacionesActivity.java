...
public class Calificaciones_Admin_MisCalificacionesActivity extends AppCompatActivity {
    ...
    void updateLista(String reportList) {
        ...
        listItems = (ListView) findViewById(R.id.listaMisCalificaciones);
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                //Solo muestro citas calificadas
                if(citaCalificada == 1){
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    adaptadorCitas = new AdaptadorListadoCitasAdmin(Calificaciones_Admin_MisCalificacionesActivity.this, ListItems);
            ...
            listItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    Intent i = new Intent(getApplicationContext(), Calificaciones_Admin_DetalleMisCalificaciones.class);
