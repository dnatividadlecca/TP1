...
public class Citas_Cliente_ListadoServiciosSeleccionarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_citas_cliente_listado_servicios_seleccionar);
        setUrlOrigin();
        cargarServicios();
    }
    ...
    void updateLista(String reportList) {
        ...
        try {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    adaptadorServicios = new AdaptadorServicios(Citas_Cliente_ListadoServiciosSeleccionarActivity.this, ListItems);
            ...
            listItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    Intent i = new Intent(getApplicationContext(), Citas_Cliente_RegistrarCitaActivity.class);
                    ...
                    i.putExtra("fotoServicio", serv.getFotoServicio());
                    startActivity(i);
                }
            });
